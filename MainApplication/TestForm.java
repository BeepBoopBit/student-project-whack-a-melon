...
public class TestForm extends javax.swing.JFrame {
    ...
    public TestForm() {
        initComponents();
        _controller.addPanel(jPanel1);
        _controller.addPanel(jPanel2);
        _controller.startAll();
        _controller.delayAt(1,1500);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(18, 128, 128));
        ...
        jPanel2.setBackground(new java.awt.Color(128, 128, 18));
